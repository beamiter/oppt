...
{
    typedef std::function<void(const std::string&)> RemoveObstacleCallback;
...
public:
    ...
    void setRemoveObstacleCallback(RemoveObstacleCallback &removeObstacleCallback);
    
    void setObstaclePoseChangedCallback(PoseChangedCallback &poseChangedCallback);
...
private:
    ...
    RemoveObstacleCallback removeObstacleCallback_ = nullptr;
