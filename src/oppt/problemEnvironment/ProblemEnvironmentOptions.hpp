...
struct ProblemEnvironmentOptions : public oppt::Options {
    ...
    /** @brief Determines if states for which the robot collides with an obstacle
     * are terminal states
     */
    ...
    /** @brief Name of the robot SDF file */
    ...
    /** @brief Color of the visualized particles */
    VectorFloat particleColor;    
    ...
    static void addSimulationBaseOptions(options::OptionParser* parser) {
        ...
        parser->addOptionWithDefault<unsigned int>("simulation",
                ...
                30);
        parser->addOptionWithDefault<VectorFloat>("simulation", 
            "particleColor", 
            &ProblemEnvironmentOptions::particleColor, 
            VectorFloat({0.2, 0.6, 0.2, 0.1}));
    }
    ...
    static void addProblemOptions(options::OptionParser* parser) {
        ...
        parser->addOption<std::string>("problem", "planningEnvironmentPath", &ProblemEnvironmentOptions::planningEnvironmentPath);
        parser->addOption<std::string>("problem", "executionEnvironmentPath", &ProblemEnvironmentOptions::executionEnvironmentPath);
        parser->addOption<std::string>("problem", "robotPath", &ProblemEnvironmentOptions::robotPath);
