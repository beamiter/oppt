...
class Obstacle;
/** @brief std::shared_ptr to oppt::Obstacle */
typedef std::shared_ptr<oppt::Obstacle> ObstacleSharedPtr;
/** @brief Vector of oppt::ObstacleSharedPtr */
typedef std::vector<ObstacleSharedPtr> VectorObstaclePtr;
/** @brief std::unique_ptr to oppt::Obstacle */
typedef std::unique_ptr<oppt::Obstacle> ObstacleUniquePtr;
...
typedef std::shared_ptr<fcl::CollisionGeometry> CollisionGeometrySharedPtr;
...
typedef boost::shared_ptr<fcl::CollisionGeometry> CollisionGeometrySharedPtr;
...
class DiscreteCollisionReport;
/** @brief std::shared_ptr to oppt::DiscreteCollisionReport */
typedef std::shared_ptr<DiscreteCollisionReport> DiscreteCollisionReportSharedPtr;

class ContinuousCollisionReport;
/** @brief std::shared_ptr to oppt::ContinuousCollisionReport */
typedef std::shared_ptr<ContinuousCollisionReport> ContinuousCollisionReportSharedPtr;

class ExtendedCollisionReport;
/** @brief std::shared_ptr to oppt::ExtendedCollisionReport */
typedef std::shared_ptr<ExtendedCollisionReport> ExtendedCollisionReportSharedPtr;
...
typedef std::shared_ptr<OpptCollisionObject> OpptCollisionObjectSharedPtr;
typedef std::vector<OpptCollisionObjectSharedPtr> VectorCollisionObjects;
