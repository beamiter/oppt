...
VectorGeometryPtr RobotImplSDFParser::parseCollisionGeometries(const std::string& robotFile) const
{
    VectorGeometryPtr robotGeometries;
    const std::string file = robotFile;
...
VectorGeometryPtr RobotImplSDFParser::parseVisualGeometries(const std::string& robotFile) const
{
    VectorGeometryPtr robotGeometries;
    const std::string file = robotFile;
    sdf::SDFPtr sdfModel(new sdf::SDF());
