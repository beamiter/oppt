...
public:
     ...
     *
     * @param robotEnvironment A pointer to the robotEnvironment this plugin resides in
    ...
    virtual bool load(RobotEnvironment* const robotEnvironment,
                      const std::string& optionsFile) = 0;
...
public:
    ...
    virtual HeuristicPluginSharedPtr clone(RobotEnvironment* const robotEnvironment) const = 0;
};
...
public:
    ...
    virtual FloatType calcLikelihood(const RobotStateSharedPtr& state,
                                     ...
                                     const ObservationSharedPtr& observation) const {
        return 1.0;
    }
