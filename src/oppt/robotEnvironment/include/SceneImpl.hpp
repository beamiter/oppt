...
public:
    ...
    virtual bool changeObstaclePose(const std::string& name, const geometric::Pose& pose, bool executeCallback = true) override;
    ...
    virtual void setChangeObstaclePoseCallback(std::function<void(const std::string&, const geometric::Pose&)> callbackFunction) override;
