...
public:
    ...
    virtual bool load(RobotEnvironment* const robotEnvironment,
        ...
        unsigned int numStateDimensions = robotEnvironment->getRobot()->getStateSpace()->getNumDimensions();        
    ...
    virtual HeuristicPluginSharedPtr clone(RobotEnvironment * const robotEnvironment) const override {
        std::shared_ptr<HeuristicPlugin> clonedPlugin(new ManipulatorRRTHeuristicPlugin());
