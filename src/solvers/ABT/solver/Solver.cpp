                           ...
                           double timeout)
{
    ...
    double startTime = oppt::clock_ms();
    long actualNumHistories = multipleSearches(startNode,
                              sampler,
                              maximumDepth,
                              numberOfHistories,
                              startTime + timeout);
    double totalTimeTaken = oppt::clock_ms() - startTime;
                            ...
                            bool propagateQChanges)
{
    ...
    double discountFactor = static_cast<oppt::ABTExtendedOptions const*>(options_)->discountFactor;
